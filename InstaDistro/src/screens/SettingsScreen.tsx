...
import { Info, Trash2, HelpCircle, Mail, Shield, Moon, Sun } from 'lucide-react-native';
import Toast from 'react-native-toast-message';
import { MESSAGES, APP_INFO } from '../constants';
...
export function SettingsScreen() {
  ...
  const handleClearData = () => {
    Alert.alert(
      'Clear All Data',
      MESSAGES.CONFIRMATIONS.CLEAR_ALL_DATA,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            Toast.show({
              type: 'success',
              text1: MESSAGES.SUCCESS.DATA_CLEARED,
            });
          },
        },
      ]
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <List.Item
            ...
            left={(props) =>
              isDarkMode ? (
                <Moon {...props} size={24} color={colors.primary.main} />
              ) : (
                <Sun {...props} size={24} color={colors.warning} />
              )
            }
            right={() => (
              <Switch
        ...
        <View style={styles.section}>
          ...
          <List.Item
            title="Version"
            description={`${APP_INFO.VERSION} (${APP_INFO.BUILD})`}
          ...
          <List.Item
            title="Total Effects"
            description="87 professional effects available"
            left={(props) => <Info {...props} size={24} color={colors.light.textSecondary} />}
          />
        </View>
          ...
          <List.Item
            ...
            onPress={() => {
              Toast.show({
                type: 'info',
                text1: 'Quick Guide',
                text2: MESSAGES.INFO.GUIDE.FULL,
                visibilityTime: 4000,
              });
            }}
          />
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>{APP_INFO.NAME} {APP_INFO.VERSION}</Text>
