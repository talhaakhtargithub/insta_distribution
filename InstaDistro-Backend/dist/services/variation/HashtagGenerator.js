...
exports.hashtagGenerator = exports.HashtagGenerator = void 0;
...
class HashtagGenerator {
    ...
    createHashtagVariation(baseHashtags, niche = 'default', accountId) {
        const count = (0, variations_1.randomIntInRange)(this.settings.minCount, this.settings.maxCount);
...
exports.hashtagGenerator = new HashtagGenerator();
