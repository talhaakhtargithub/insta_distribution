...
class HealthScorer {
     ...
     */
    compareToBaseline(current, historical) {
     ...
     */
    getHealthScoreBreakdown(metrics) {
...
exports.default = new HealthScorer();
