...
exports.ApiError = exports.ErrorStatusMap = exports.ErrorCode = void 0;
...
(function (ErrorCode) {
    ...
    ErrorCode["ACCOUNT_NOT_AUTHENTICATED"] = "ACCOUNT_NOT_AUTHENTICATED";
    ErrorCode["ACCOUNT_WARMING_UP"] = "ACCOUNT_WARMING_UP";
    ...
    ErrorCode["POST_ALREADY_SCHEDULED"] = "POST_ALREADY_SCHEDULED";
    ErrorCode["POST_SCHEDULING_FAILED"] = "POST_SCHEDULING_FAILED";
    ErrorCode["INVALID_MEDIA_FORMAT"] = "INVALID_MEDIA_FORMAT";
    ErrorCode["MEDIA_TOO_LARGE"] = "MEDIA_TOO_LARGE";
    ErrorCode["CAPTION_TOO_LONG"] = "CAPTION_TOO_LONG";
    // Schedule Errors (5000-5999)
    ErrorCode["SCHEDULE_NOT_FOUND"] = "SCHEDULE_NOT_FOUND";
    ErrorCode["SCHEDULE_CONFLICT"] = "SCHEDULE_CONFLICT";
    ErrorCode["INVALID_TIME_SLOT"] = "INVALID_TIME_SLOT";
    // Proxy Errors (6000-6999)
    ErrorCode["PROXY_NOT_FOUND"] = "PROXY_NOT_FOUND";
    ErrorCode["PROXY_CONNECTION_FAILED"] = "PROXY_CONNECTION_FAILED";
    ErrorCode["PROXY_AUTHENTICATION_FAILED"] = "PROXY_AUTHENTICATION_FAILED";
    // Warmup Errors (7000-7999)
    ErrorCode["WARMUP_NOT_FOUND"] = "WARMUP_NOT_FOUND";
    ErrorCode["WARMUP_ALREADY_ACTIVE"] = "WARMUP_ALREADY_ACTIVE";
    ErrorCode["WARMUP_NOT_STARTED"] = "WARMUP_NOT_STARTED";
    // Group Errors (8000-8999)
    ErrorCode["GROUP_NOT_FOUND"] = "GROUP_NOT_FOUND";
    ErrorCode["GROUP_ALREADY_EXISTS"] = "GROUP_ALREADY_EXISTS";
    ...
    ErrorCode["INSTAGRAM_RATE_LIMIT"] = "INSTAGRAM_RATE_LIMIT";
    ErrorCode["INSTAGRAM_LOGIN_REQUIRED"] = "INSTAGRAM_LOGIN_REQUIRED";
    ErrorCode["INSTAGRAM_CHECKPOINT"] = "INSTAGRAM_CHECKPOINT";
    ErrorCode["INSTAGRAM_SHADOWBAN"] = "INSTAGRAM_SHADOWBAN";
 ...
 */
function createSuccessResponse(data, meta, requestId) {
    return {
        success: true,
        data,
        ...(meta && { meta }),
...
class ApiError extends Error {
    ...
    constructor(code, message, details) {
        ...
        this.name = 'ApiError';
        this.code = code;
        this.statusCode = exports.ErrorStatusMap[code] || 500;
